                        ...
                        <div class="thumb">
                            <div class="hover-content">
                                <ul>
                                    ...
                                    <li><a href="single-product.php?id=<?php echo $row['id']; ?>"><i class="fa fa-star"></i></a></li>
                                    <li><a href="single-product.php?id=<?php echo $row['id']; ?>"><i class="fa fa-shopping-cart"></i></a></li>
                                </ul>
                            </div>
